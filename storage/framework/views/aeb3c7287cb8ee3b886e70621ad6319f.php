...
<?php $__env->startSection('title', 'Edit Movie — Video Store'); ?>
...
<div class="container">
    ...
    <div class="form-card">
        ...
        <form method="POST" action="<?php echo e(route('movies.update', $movie->movie_id)); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <select name="category">
                <?php $__currentLoopData = ['comedy','suspense','drama','action','SciFi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($cat); ?>" <?php echo e(old('category', $movie->category) == $cat ? 'selected' : ''); ?>><?php echo e(ucfirst($cat)); ?></option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <input type="text" name="director" value="<?php echo e(old('director', $movie->director)); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <label>Year</label>
            <input type="number" name="year" value="<?php echo e(old('year', $movie->year)); ?>" min="1900" max="2099">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Charlz keneth\video_store\resources\views/movies/edit.blade.php ENDPATH**/ ?>